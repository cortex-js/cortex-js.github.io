...
/* 0.29.1 */import type { BoxedExpression, ComputeEngine, IdentifierDefinitions } from '../global-types';
...
/* 0.29.1 */import { IdentifierDefinitions } from '../global-types';
...
/* 0.29.1 */import type { BoxedExpression, SemiBoxedExpression, SymbolDefinition, BoxedSymbolDefinition, CollectionHandlers, ComputeEngine, NumericFlags, RuntimeScope, Sign } from '../global-types';
...
/* 0.29.1 */import type { BoxedExpression, FunctionDefinition, SemiBoxedExpression, SymbolDefinition, NumericFlags, ComputeEngine, Metadata } from '../global-types';
import { Type } from '../../common/type/types';
 ...
 * @returns
 */
export declare function getMeta(expr: BoxedExpression): Partial<Metadata>;
...
export declare function infinitySgn(s: Sign | undefined): boolean | undefined;
/**
 * Sign `s` is > 0.
 *
 * :::info[Note]
...
/* 0.29.1 */import { TensorField } from './tensor-fields';
